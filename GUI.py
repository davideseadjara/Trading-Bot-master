...
def start():
    ...
    if btn_start['text'] == 'Start':
        ...
        apiKey = ent_apiKey.get()
        apiSecret = ent_apiSecret.get()
        userids = ent_userId.get().split(',')
        ...
        main = trader(symbol, timeframe, exchange, quantity, isFutures, isLive, apiKey, apiSecret, userids)
...
if __name__ == '__main__':
    # Title
    lbl_title = ttk.Label(master = window, text = 'Trading bot', font = ("Helvetica",30, "italic"))
